...
function buildSidebarLinks(role: UserRole): SidebarLink[] {
    ...
    if (role === "admin") {
        ...
        links.push({ href: "/admin/auditoria", label: "Auditoria", icon: ShieldCheck });
    }

    links.push({ href: "/admin/perfil", label: "Perfil", icon: UserCircle2 });
...
function AdminSidebar({
    ...
    const sidebarLinks = buildSidebarLinks(role);
                ...
                <div className="flex h-16 items-center justify-between border-b border-border px-4">
                    <Link href="/admin/dashboard" className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-semibold text-foreground">
                            Painel {role === "admin" ? "Admin" : "Operador"}
                        </span>
                    </Link>
                    <button
                        onClick={onClose}
