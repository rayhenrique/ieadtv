    ...
    return (
        <div className="mx-auto max-w-[1200px] px-4 py-12 sm:px-6">
            ...
            <p className="mt-2 text-muted-foreground">
                Acompanhe as notícias e projetos missionários da AD Teotônio
                Vilela.
            </p>
            ...
            {noticias.length > 0 ? (
                ...
                <div className="mt-8 rounded-lg border border-border p-8 text-center">
                    <p className="text-muted-foreground">
                        Nenhuma notícia de missões publicada ainda.
                    </p>
                    <p className="mt-2 text-sm text-muted-foreground">
                        Para que notícias apareçam aqui, crie uma categoria com
                        o slug &quot;missao&quot; e vincule notícias a ela.
                    </p>
                </div>
            )}
        </div>
